...
<body>
  <div class="TC">
    ...
    <p style="text-align:justify;">
            Welcome to <b>Print Tactics</b> (“Company”, “we”, “our”, “us”)!
            These Terms of Service (“Terms”, “Terms of Service”) govern your use of our website located at <b>printactics.rf.gd</b> (together or individually “Service”) operated by <b>Print Tactics</b>
            Our Privacy Policy also governs your use of our Service and explains how we collect, safeguard and disclose information that results from your use of our web pages.
            Your agreement with us includes these Terms and our Privacy Policy (“Agreements”). You acknowledge that you have read and understood Agreements, and agree to be bound of them.
            If you do not agree with (or cannot comply with) Agreements, then you may not use the Service, but please let us know by emailing at <b>macarilaoj@gmail.com</b> so we can try to find a solution. 
        ...
        of these communications from us by emailing us at <b>macarilaoj@gmail.com</b>.
        </p>
        ...
        your payment method, your billing address, and your shipping information.You represent and warrant that: 
        (i) you have the legal right to use any card(s) 
        or other payment method(s) in connection with any Purchase; and that (ii) the information you supply to us is true, correct and complete. 
        ...
        We reserve the right to refuse or cancel your order at any time for reasons including but not limited to: product or service availability, errors in the description or price of the product or service, 
        error in your order or other reasons.We reserve the right to refuse or cancel your order if fraud or an unauthorized or illegal transaction is suspected. 
        </p>
            <!-- this 4. THIS WORDS NA WALA SA SYSTEM NEED NATIN GAWAN IF.. OR IF HINDI NLNG REVISE NATIN TOHLOL-->
        <strong>4. CONTEST, SWEEPTAKES AND PROMOTIONS</strong>
        <p style="text-align:justify;">
        ...
        <strong>5. REFUNDS </strong>
        <p style="text-align:justify;">
        We issue refunds for Contracts within <b>2 days</b> of the original purchase of the Contract. 
        </p>

        <strong>6. CONTENT</strong>
        <p style="text-align:justify;">
        Content found on or through this Service are the property of Print Tactics or used with permission. 
        ...
        <p style="text-align:justify;">
        You may use Service only for lawful purposes and in accordance with Terms.<br>You agree not to use Service:
        </p>
        <ul>
            <li>
      ...
      <strong>8. ANALYTICS</strong>
      <p style="text-align:justify;">
      We may use third-party Service Providers to monitor and analyze the use of our Service. 
      </p>

      <strong>9. NO USE BY MINORS</strong>
      <p style="text-align:justify;">
      ...
      <p style="text-align:justify;"> 
      Service and its original content (excluding Content provided by users), features and functionality are and will remain the exclusive property of Print Tactics and its licensors. Service is protected by copyright, trademark, and other laws of and foreign countries. 
      Our trademarks may not be used in connection with any product or service without the prior written consent of Print Tactics.
    </p>

      <strong>12. COPYRIGHT POLICY</strong>
      <p style="text-align:justify;"> 
      ...
      <strong>13. ERROR REPORTING AND FEEDBACK</strong>
      <p style="text-align:justify;"> You may provide us either directly at macarilaoj@gmail.com or via third party sites and tools with information and feedback concerning errors, suggestions for improvements, ideas, problems, complaints, and other matters related to our Service (“Feedback”). You acknowledge and agree that: (i) you shall not retain, acquire or assert any intellectual property right or other right, title or interest in or to the Feedback; (ii) Company may have development ideas similar to the Feedback; (iii) Feedback does not contain confidential information or proprietary information from you or any third party; and (iv) Company is not under any obligation of confidentiality with respect to the Feedback. In the event the transfer of the ownership to the Feedback is not possible due to applicable mandatory laws, you grant Company and its affiliates an exclusive, transferable, irrevocable, free-of-charge, sub-licensable, unlimited and perpetual right to use (including copy, modify, create derivative works, publish, distribute and commercialize) Feedback in any manner and for any purpose.</p>

      <strong>14. LINKS TO OTHER WEB SITES</strong>
      <p style="text-align:justify;"> 
      ...
      For example, the outlined Terms of Use have been created using <a href="https://policymaker.io/">PolicyMaker.io</a>, a free web application for generating high-quality legal documents. 
      PolicyMaker’s <a href="https://policymaker.io/">Terms and Conditions generator</a> is an easy-to-use free tool for creating an excellent standard Terms of Service template for a website, blog, e-commerce store or app. 
    <br><br>YOU ACKNOWLEDGE AND AGREE THAT COMPANY SHALL NOT BE RESPONSIBLE OR LIABLE, DIRECTLY OR INDIRECTLY, FOR ANY DAMAGE OR LOSS CAUSED OR ALLEGED TO BE CAUSED BY OR IN CONNECTION WITH USE OF OR RELIANCE ON ANY SUCH CONTENT, GOODS OR SERVICES AVAILABLE ON OR THROUGH ANY SUCH THIRD PARTY WEB SITES OR SERVICES. WE STRONGLY ADVISE YOU TO READ THE TERMS OF SERVICE AND PRIVACY POLICIES OF ANY THIRD PARTY WEB SITES OR SERVICES THAT YOU VISIT. 
      ...
      <strong>20. AMENDMENTS TO TERMS</strong>
      <p style="text-align:justify;">We may amend Terms at any time by posting the amended terms on this site. It is your responsibility to review these Terms periodically. Your continued use of the Platform following the posting of revised Terms means that you accept and agree to the changes. You are expected to check this page frequently so you are aware of any changes, as they are binding on you. By continuing to access or use our Service after any revisions become effective, you agree to be bound by the revised terms. If you do not agree to the new terms, you are no longer authorized to use Service. </p>

      <strong>21. WAIVER AND SEVERABILITY</strong>
      ...
      <strong>22. ACKNOWLEDGEMENT</strong>
      <p style="text-align:justify;"> BY USING SERVICE OR OTHER SERVICES PROVIDED BY US, YOU ACKNOWLEDGE THAT YOU HAVE READ THESE TERMS OF SERVICE AND AGREE TO BE BOUND BY THEM. 
    </p>

      <strong>23. CONTACT US</strong>
      <p style="text-align:justify;"> Please send your feedback, comments, requests for technical support by E-mail: <b>macarilaoj@gmail.com</b>. 
These Terms of Service were created for printtactics.com by PolicyMaker.io on 2022-05-18. </p>
    </div>
